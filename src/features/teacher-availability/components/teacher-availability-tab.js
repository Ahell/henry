...
export class TeacherAvailabilityTab extends LitElement {
  ...
  _renderLegend(isDetailView) {
    ...
    const items = [
      ...
      {
        label: "Tilldelad + delvis otillgänglig",
        meta: "Tilldelad men upptagen vissa aktiva kursdagar (röda ränder)",
        swatchClass: "legend-swatch--assigned-partial-conflict",
      },
      {
        label: "Tilldelad + otillgänglig",
        meta: "Tilldelad men upptagen alla aktiva kursdagar (starka röda ränder)",
        swatchClass: "legend-swatch--assigned-course-unavailable",
      },
      {
        label: "Kompatibel + delvis otillgänglig",
        meta: "Kompatibel men upptagen vissa aktiva kursdagar (röda ränder)",
        swatchClass: "legend-swatch--partial-conflict",
      },
      {
        label: "Kompatibel + otillgänglig",
        meta: "Kompatibel men upptagen alla aktiva kursdagar (starka röda ränder)",
        swatchClass: "legend-swatch--course-unavailable",
      },
      {
        label: "Delvis otillgänglig",
        meta: "Ingen kurs i slotten: läraren är upptagen vissa dagar",
